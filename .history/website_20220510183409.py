...
class Website():
    ...
    def __init__(self):
        ...
        # x_button = self.driver.find_element(By.CLASS_NAME, "close-icon")
        x_button = self.driver.execute_script("return document.querySelector('game-app').shadowRoot.querySelector('game-theme-manager').querySelector('#game').querySelector('game-modal').shadowRoot.querySelector('.close-icon')")
        x_button.click()
