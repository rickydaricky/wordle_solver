...
class WordsController():
    ...
    def __init__(self, word_length):
        ...
        self.unknown_location_options = collections.defaultdict(list)
    ...
    def valid_known_locations(known_location_options, word):
        ...
        for index, letter in known_location_options.items():
            if word[index] != letter and letter != '':
                return False
    ...
    def choose_word(self):
        ...
        print(self.unknown_location_options)
    ...
    def update_info(self, new_wrong, new_unknown, now_known):
        ...
        for letter, wrong_index in new_unknown:
            # if letter not in self.unknown_location_options:
            # self.unknown_locations_options[letter] = []
            
            self.unknown_location_options[letter] += (wrong_index)
