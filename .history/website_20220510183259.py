...
class Website():
    ...
    def __init__(self):
        ...
        x_button = self.driver.execute_script("return document.querySelector('impulse-search').shadowRoot.querySelector('div.group-name-brand h1.impulse-title span.formatted-text')")
        x_button.click()
